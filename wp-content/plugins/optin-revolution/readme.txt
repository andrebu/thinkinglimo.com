=== WordPress Popup - Optin Revolution ===
...
Optin Revolution Lite allows you to create a single WordPress popup. If you'd like more than one popup, check out Optin Revolution Pro.
...
= 1.4.2 =
* Updated: Social media removed

= 1.4.1 =
* Bug Fix: Wysija / MailPoet integration
* Bug Fix: Woocommerce issue of W3 Total Cache defined var
* Updated: Enabled bullets color in text editing

= 1.4.0 =
* Bug Fix: Disabled href link in editing area

= 1.3.9 =
* Bug Fix: Constant contact url form

= 1.3.8 =
* Updated: Real path into wp site url to avoid plugin directory restriction
