...
<form id="shopingcartfrm2" name="shopingcartfrm">
  ...
  <div class="row ">
  <label><?php _e('Qty:');?></label> <input name="product_qty" id="product_qty2" type="text" onKeyPress="return numberonly(event)" value="1" class="textbox" />
  </div>
...
{
?>
  <div class="b_addtocart2"  id="shoppingcart_button_2" ><a href="javascript:void(0);" onclick="setAttributeVal2();">addtocart</a> </div>
   <span id="shoppingcart_outofstock_msg2"></span>
<?php }?> 
</form><br /><br /><br />
<span id="addtocartformspan2" class="clearfix">
