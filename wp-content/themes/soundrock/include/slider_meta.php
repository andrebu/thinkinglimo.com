    ...
    <div class="poped-up" id="edit_<?php echo $counter?>">
        ...
        <div class="opt-conts">
            <ul class="form-elements">
                ...
                <li class="to-field">
                    <input type="text" name="cs_slider_title[]" value="<?php echo esc_attr($cs_slider_title_db)?>" class="txtfield" />
                </li>
            </ul>
            <ul class="form-elements">
                <li class="to-label">
                ...
                <li class="to-field">
                    <textarea class="txtarea" name="cs_slider_description[]"><?php echo $cs_slider_description_db?></textarea>
                </li>
            </ul>
            <ul class="form-elements">
                <li class="to-label">
                ...
                <li class="to-field">
                    <input type="text" name="cs_slider_link[]" value="<?php echo $cs_slider_link_db?>" class="txtfield" />
                </li>
            </ul>
            <ul class="form-elements">
                <li class="to-label">
            ...
            <ul class="form-elements">
                ...
                <li class="to-field">
                    <select name="cs_slider_box_align[]" class="select_dropdown">
                        <option <?php if($cs_slider_box_align_db=="Left")echo "selected";?> >Left</option>
                        <option <?php if($cs_slider_box_align_db=="Right")echo "selected";?> >Right</option>
                    </select>
                </li>
                <li class="to-desc">
