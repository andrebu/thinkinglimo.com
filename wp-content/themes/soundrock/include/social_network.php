                        	...
                        	<form id="frm" method="post" action="javascript:frm_submit()">
                                ...
                                <div class="opt-conts">
                                    ...
                                    <ul class="form-elements">
                                        ...
                                        <li class="to-field">
                                            <input type="text" name="digg" value="<?php echo $digg ?>" />
                                        </li>
                                        <li class="to-desc">
                                            <div class="icon-thumb">
                                    ...
                                    <ul class="form-elements">
                                        ...
                                        <li class="to-field">
                                            <input type="text" name="delicious" value="<?php echo $delicious ?>" />
                                        </li>
                                        <li class="to-desc">
                                            <div class="icon-thumb">
                                    ...
                                    <ul class="form-elements">
                                        ...
                                        <li class="to-field">
                                            <input type="text" name="google_buzz" value="<?php echo $google_buzz ?>" />
                                        </li>
                                        <li class="to-desc">
                                            <div class="icon-thumb">
                                    ...
                                    <ul class="form-elements">
                                        ...
                                        <li class="to-field">
                                            <input type="text" name="google_bookmark" value="<?php echo $google_bookmark ?>" />
                                        </li>
                                        <li class="to-desc">
                                            <div class="icon-thumb">
                                    ...
                                    <ul class="form-elements">
                                        ...
                                        <li class="to-field">
                                            <input type="text" name="myspace" value="<?php echo $myspace ?>" />
                                        </li>
                                        <li class="to-desc">
                                            <div class="icon-thumb">
                                    ...
                                    <ul class="form-elements">
                                        ...
                                        <li class="to-field">
                                            <input type="text" name="reddit" value="<?php echo $reddit ?>" />
                                        </li>
                                        <li class="to-desc">
                                            <div class="icon-thumb">
                                    ...
                                    <ul class="form-elements">
                                        ...
                                        <li class="to-field">
                                            <input type="text" name="stumbleupon" value="<?php echo $stumbleupon ?>" />
                                        </li>
                                        <li class="to-desc">
                                            <div class="icon-thumb">
                                    ...
                                    <ul class="form-elements">
                                        ...
                                        <li class="to-field">
                                            <input type="text" name="feedburner" value="<?php echo $feedburner ?>" />
                                        </li>
                                        <li class="to-desc">
                                            <div class="icon-thumb">
                                    ...
                                    <ul class="form-elements">
                                        ...
                                        <li class="to-field">
                                            <input type="text" name="flickr" value="<?php echo $flickr ?>" />
                                        </li>
                                        <li class="to-desc">
                                            <div class="icon-thumb">
                                    ...
                                    <ul class="form-elements">
                                        ...
                                        <li class="to-field">
                                            <input type="text" name="picasa" value="<?php echo $picasa ?>" />
                                        </li>
                                        <li class="to-desc">
                                            <div class="icon-thumb">
                                    ...
                                    <ul class="form-elements">
                                        ...
                                        <li class="to-field">
                                            <input type="text" name="vimeo" value="<?php echo $vimeo ?>" />
                                        </li>
                                        <li class="to-desc">
                                            <div class="icon-thumb">
                                    ...
                                    <ul class="form-elements">
                                        ...
                                        <li class="to-field">
                                            <input type="text" name="tumblr" value="<?php echo $tumblr ?>" />
                                        </li>
                                        <li class="to-desc">
                                            <div class="icon-thumb">
