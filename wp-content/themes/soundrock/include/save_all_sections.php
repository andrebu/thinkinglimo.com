		...
		foreach ( $_POST['cs_orderby'] as $count ){
			if ( $_POST['cs_orderby'][$counter] == "rich_editor" ) {
				...
				$event = $sxe->addChild('event');
					$event->addChild('cs_event_title', $_POST['cs_event_title'][$counter_event] );
				...
				$slider = $sxe->addChild('blog');
					$slider->addChild('cs_blog_title', $_POST['cs_blog_title'][$counter_blog] );
				...
				$slider = $sxe->addChild('news');
					$slider->addChild('cs_news_title', $_POST['cs_news_title'][$counter_news] );
