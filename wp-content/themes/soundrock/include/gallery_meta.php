    ...
    <div class="poped-up" id="edit_<?php echo $counter?>">
        ...
        <div class="opt-conts">
            <ul class="form-elements">
                ...
                <li class="to-field">
                    <input type="text" name="title[]" value="<?php echo esc_attr($title_db)?>" class="txtfield" />
                </li>
            </ul>
            <ul class="form-elements">
                <li class="to-label">
                ...
                <li class="to-field">
                    <textarea class="txtarea" name="description[]"><?php echo $description_db?></textarea>
                </li>
            </ul>
            <ul class="form-elements">
                <li class="to-label">
            ...
            <ul class="form-elements" id="video_code<?php echo $counter?>" <?php if($use_image_as_db=="0" or $use_image_as_db=="")echo 'style="display:none"';?> >
                ...
                <li class="to-field">
                    <input type="text" name="video_code[]" value="<?php echo $video_code_db?>" class="txtfield" />
                </li>
                <li class="to-desc">
