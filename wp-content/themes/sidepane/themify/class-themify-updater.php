...
class Themify_Upgrader_Skin extends WP_Upgrader_Skin {
	...
	function __construct($args = array()) {
		$defaults = array(	'type' 	=> '',	'login' => '',	'url' 	=> '', 'theme' => '',
							'nonce' => '',	'title' => __('Update Theme'), 'cookies' => null );
	...
	function after() {
		...
		$update_actions['themes_page'] = '<a href="' . self_admin_url('admin.php?page=themify') . '" title="' . __('Return to Themify Panel') . '" target="_parent">' . __('Return to Themify Panel') . '</a>';
	...
	function tcopydir($from, $to, $skip_list = array() ) {
		...
		foreach ( (array) $dirlist as $filename => $fileinfo ) {
			...
			if ( in_array( $filename, $skip_list ) ){
				echo '<p><strong>Skipping ' . $filename . '</strong></p>';
				continue; 
			}
