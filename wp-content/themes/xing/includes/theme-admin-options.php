...
$options = array (
				...
				array(	"name" => __( 'Contact e-mail', 'xing' ),
						"desc" => __( 'Enter an e-mail address to which mail should be received from contact page. If left blank, your blog admin email is used.', 'xing' ),
						"id" => $shortname."_email",
						"std" => "",
						"type" => "text"),

				array(	"name" => __( 'Contact Page custom Markup<br/>(Can be used for Google Maps)', 'xing' ),
						"desc" => __( 'Visit maps.google.com and copy your map location iFrame code. Paste it here. This will be shown on contact page template. Recommended dimensions for iframe <code>width="100%" height="320px"</code><br/>Tip: You can also use any custom markup or HTML here instead of Google Maps.', 'xing' ),
