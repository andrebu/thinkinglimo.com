...
if( !function_exists( 'render_service_box' ) ) {
    function render_service_box($metadata, $servicegrid='one_fourth', $last='', $home = false, $colnumber=1) { 			
				...
				if($home) { 
					...
					$metadata['col_icon']			= 	isset($metadata['col_'.$colnumber.'_icon']) ? $metadata['col_'.$colnumber.'_icon'] : '';
					$metadata['col_alt']			= 	isset($metadata['col_'.$colnumber.'_icon_alt']) ? $metadata['col_'.$colnumber.'_icon_alt'] : '';
					$metadata['col_headline']		= 	isset($metadata['col_'.$colnumber.'_headline']) ? $metadata['col_'.$colnumber.'_headline'] : '';
					$metadata['col_content']		= 	isset($metadata['col_'.$colnumber.'_content']) ? $metadata['col_'.$colnumber.'_content'] : '';
					$metadata['col_buttontext']		= 	isset($metadata['col_'.$colnumber.'_buttontext']) ? $metadata['col_'.$colnumber.'_buttontext'] : '';
					$metadata['col_link']			= 	isset($metadata['col_'.$colnumber.'_link']) ? $metadata['col_'.$colnumber.'_link'] : '';
					$metadata['col_bgcolor']		= 	isset($metadata['col_'.$colnumber.'_bgcolor']) ? $metadata['col_'.$colnumber.'_bgcolor'] : '#222';
					$metadata['col_textcolor']		= 	isset($metadata['col_'.$colnumber.'_textcolor']) ? $metadata['col_'.$colnumber.'_textcolor'] : '#FFF';
					$metadata['col_texthovercolor']	= 	isset($metadata['col_'.$colnumber.'_texthovercolor']) ? $metadata['col_'.$colnumber.'_texthovercolor'] : '#FFF';
					$metadata['col_hovercolor']		= 	isset($metadata['col_'.$colnumber.'_hovercolor']) ? $metadata['col_'.$colnumber.'_hovercolor'] : get_option_tree('color_scheme');
				...
				<?php } ?>							
                    ...
                    <a style="color:<?php echo $metadata['col_textcolor']; ?>" data-textcolor="<?php echo $metadata['col_textcolor']; ?>" data-texthovercolor="<?php echo $metadata['col_texthovercolor']; ?>" href="<?php echo lambda_translate_meta($metadata['col_link']); ?>" target="_self">
                    <article class="service-box" style="background:<?php echo $metadata['col_bgcolor']; ?>;" data-bgcolor="<?php echo $metadata['col_bgcolor']; ?>" data-hovercolor="<?php echo $metadata['col_hovercolor']; ?>">
                                
                                <h3 style="color:<?php echo $metadata['col_textcolor']; ?>">
                                ...
                                $parsed_url = parse_url($metadata['col_icon']);
                                ...
                                <figure class="service-box-icon">
                                    <img src="<?php echo $metadata['col_icon']; ?>" alt="<?php echo (!empty($metadata['col_alt']) ) ? $metadata['col_alt'] : $filename; ?>" />
                                </figure>
