...
// jQuery(".circular-bar-green").donutchart({'size': 150, 'fgColor': '#000' });
...
if ($testo === false) {
    ...
    // jQuery('.flatcar').stop(true,true).animate({
				// 		'background-position-x' : parseInt(jQuery(this).scrollTop()*0.25)
				// 	},{queue:false, duration:250, easing: 'easeOutCubic'});	
