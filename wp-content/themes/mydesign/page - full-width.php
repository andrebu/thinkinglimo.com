...
if ( (function_exists('has_post_thumbnail')) && has_post_thumbnail() ) :
	...
	$thumb_image_url = aq_resize( $full_image_url, 960, 440, true );
else :
...
<div class="blog_header">
  ...
  <div class="clearfix">
    <div class="sixteen columns alpha" style="background:#fff;color:#fff;">
...
<div class="comments_area">
	<?php comments_template( '/full-comments.php', true ); ?>
</div>
