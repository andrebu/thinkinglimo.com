 ...
 *
 * The template for displaying Homapage
 */

 get_header(); ?>
<div style="background:#fff;">
<div id="banner"></div><div id="href_home"></div> <?php
$homepage_blocks = (isset($smof_data['homepage_blocks3'])) ? $smof_data['homepage_blocks3']['enabled'] : array();
$i = 0;
    ...
    switch ($key) :
        case 'Slider': ?>
            ...
            <div class="bg-slider"><div id="href_slider"></div>   
                <?php if( function_exists('layerslider') ) layerslider($smof_data['ls_id']); ?>
            </div>
             <!--LayerSlider end-->
        <?php 
        break;
            ...
            ?>
              <section id="intro" class="bg-intro" style="background:url(<?php echo $Introduction_bg ;?>) <?php echo $Introduction_color ;?>;overflow:auto;">
                  <div class="section-one sixteen columns clearfix">
                      <div class="intro-title fadeitin"><?php echo $smof_data['homepage_intro_header'] ?></div>
                       <div class="data-content-one fadeitin">
                        <?php echo do_shortcode($smof_data['homepage_intro_text']) ?>
                      </div>
                  </div>
              </section><!-- end Intro -->
        <?php 
        ...
        case 'features': ?>
              <!--     Services Section     -->
                  <section id="SERVICES" class="bg-one"><div id="href_features"></div>
                      <div class="section-one sixteen columns clearfix">
                        <div class="service-title fadeitin"><img src="<?php echo get_template_directory_uri(); ?>/img/magic-hat.png" class="service-img" alt="designicon"><?php echo $smof_data['features_title']; ?></div>
                          <div class="data-content-service fadeitin">
                            <?php echo $smof_data['features_text']; ?>
                          </div>
                            <?php if (!empty($smof_data['features_slider'])) { ?>
                              <div class="services-tiles">

                                <?php foreach ($smof_data['features_slider'] as $key => $value) :
                          ...
                          <?php } 
                          if ((isset($smof_data['features_tagline'] )) && ($smof_data['features_tagline']!=="") ) {
                          ?>
                          <div class="services-note fadeitin">
                              <p class="services-note-text"><?php echo do_shortcode($smof_data['features_tagline']); ?></p>
                          </div>
                          <?php } ?>
      ...
      <!--         MileStone Section           -->
        <?php
        if ((isset($smof_data['milestone_bg'] )) && ($smof_data['milestone_bg']!=="") ) {
                $milestone_bg = $smof_data['milestone_bg'];
            }else{
                $milestone_bg = "";
            }
            if ((isset($smof_data['milestone_color'] )) && ($smof_data['milestone_color']!=="") ) {
                $milestone_color = $smof_data['milestone_color'];
            }else{
        ...
        <section id="twitter" class="bg-nums" style="background:url(<?php echo $milestone_bg ;?>) <?php echo $milestone_color ;?>;overflow:auto;">
            <div class="section-one section-stone">
                 ...
                 <div class="services-tiles services-tiles2">
                          <?php foreach ($smof_data['milestone_slider'] as $key => $value) :
                  if (!empty($value['url'])) $thumb_image_url = aq_resize( $value['url'], 100, 100, false ); ?>
        ...
        case 'features_2': ?>
              ...
              <section id="SERVICES" class="bg-one"><div id="href_features2"></div>
                  <div class="section-one">
                      <div class="service-title fadeitin"><img src="<?php echo get_template_directory_uri(); ?>/img/magic-hat.png" class="service-img" alt="designicon"><?php echo $smof_data['features_title2']; ?></div>
                      <div class="data-content-service fadeitin">
                          <?php echo $smof_data['features_text2']; ?>
                      </div>
                          <?php if (!empty($smof_data['features_slider2'])) { ?>
                              <div class="services-tiles services-tiles2">

                                  <?php foreach ($smof_data['features_slider2'] as $key => $value) :
                      ...
                      <?php } ?>
                      <?php if ((isset($smof_data['features_tagline2'] )) && ($smof_data['features_tagline2']!=="") ) { ?>
                          <div class="services-note fadeitin">
                              <p class="services-note-text"><?php echo do_shortcode($smof_data['features_tagline2']); ?></p>
                          </div>
                      <?php } ?>
                  ...
                  <div class="section-one">
                      ...
                      <div class="right-call">
                          <div class="call-button-area fadeitin">
                              <a href="<?php echo $smof_data['call_to_action_button_url']; ?>" class="call-button"><?php echo $smof_data['call_to_action_button_text']; ?></a>
                          </div>
                      </div>
        ...
        case 'posts': ?>
              ...
              <div class="works-container bg-projects"><div id="href_blog"></div> 
                  ...
                  <div class="works-header">
                      <div class="service-title fadeitin"><img src="<?php echo get_template_directory_uri(); ?>/img/lamp.png" class="service-img" alt="designicon"><?php echo do_shortcode($smof_data['blog_text']); ?></div>
                          <div class="data-content-service fadeitin">
                              <?php echo do_shortcode($smof_data['home_blog_tagline']); ?> 
                          </div>
  ...
  <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
              ...
              <div class="clear"></div>
                  ...
                  <div class="services-note fadeitin">
                      ...
                      <p></p>
                      <a id="loadbutton" href="<?php echo do_shortcode($smof_data['blog_button_link']) ?>" class="load-more-button"><?php echo do_shortcode($smof_data['blog_button']) ?></a>
        ...
        case 'quotes': ?>
              <!--     Quotes Section     -->
              <?php
                if ((isset($smof_data['testimonials_image'] )) && ($smof_data['testimonials_image']!=="") ) {
                    $testimonials_image = $smof_data['testimonials_image'];
                  }else{
                    $testimonials_image = "";
                  }
                  if ((isset($smof_data['testimonials_color'] )) && ($smof_data['testimonials_color']!=="") ) {
                    $testimonials_color = $smof_data['testimonials_color'];
                  }else{
        ...
        case 'about': ?>
              ...
              <section id="team" class="bg-one"><div id="href_about"></div>
                  <div class="section-one section-team">
                      <div class="service-title fadeitin"><img src="<?php echo get_template_directory_uri(); ?>/img/paper.png" class="service-img" alt="designicon"><?php echo $smof_data['about_title']; ?></div>
                      <div class="data-content-about fadeitin">
                          <?php echo do_shortcode($smof_data['about_info']); ?>
                      </div>
                      <div class="data-content-tagline fadeitin">
                          <?php echo do_shortcode($smof_data['about_tagline']); ?>
                      </div>
                       <div class="services-tiles">
                          <?php
                              query_posts(array(
                     ...
                     <div class="three columns tile-one team-one"> <!-- team member 1 -->
                        ...
                        <?php   endif; ?>
                          ...
                          <?php endif; ?>
                                ...
                                <?php if ($smof_data['join_us_switch'] ) { ?>
                                 <div class="three columns tile-one team-one"> <!-- team member 1 -->
                                 <div class="team-img-mask">
                                  ...
                                  <div class="team-name fadeitin"><?php echo $smof_data['join_us_title']; ?></div>
                                  <div class="team-tag fadeitin"><?php echo $smof_data['join_us_tagline']; ?></div>
                                  <p class="team-text fadeitin">
                                     <?php echo $smof_data['join_us_text']; ?>
                                  </p>
                                  <a href="<?php echo $smof_data['join_us_but']; ?>" class="team-button"><?php echo $smof_data['join_us_but_text']; ?></a>
                                </div><!-- end Team member -->
                                <?php } ?>
        ...
        case 'about_2': ?>
              <section id="team" class="bg-one"><div id="href_about2"></div>
                      <div class="section-one section-team">
                          <div class="service-title fadeitin"><img src="<?php echo get_template_directory_uri(); ?>/img/paper.png" alt="" class="service-img"><?php echo $smof_data['about_title2']; ?></div>
                          <div class="data-content-about fadeitin">
                              <?php echo do_shortcode($smof_data['about_info2']); ?>
                          </div>
                          <div class="data-content-tagline fadeitin">
                              <?php echo do_shortcode($smof_data['about_tagline2']); ?>
                          </div>

                                <div class="service-title">
                                  <?php $thumb_image_url = aq_resize( $smof_data['team_img'] , 540, 200, true ); ?>
                                  <img class="team-img2 fadeitin" src="<?php echo $thumb_image_url; ?>" alt="" title="">
                                  </div>
                                    <div class="team-name fadeitin"><?php echo $smof_data['team_title']; ?></div>
                                      <div class="team-tag fadeitin"><?php echo $smof_data['team_tagline']; ?></div>
                                      <p class="team-text2 fadeitin">
                                         <?php echo $smof_data['team_text']; ?>
                                      </p>
                                      <div class="social-links fadeitin">
                                        <?php if (!(empty($smof_data['team_facebook']))){ ?>
                                        <a href="<?php echo $smof_data['team_facebook']; ?>" class="facebook-link"></a>
                                        <?php } ?>
                                        <?php if (!(empty($smof_data['team_twitter']))){ ?>
                                        <a href="<?php echo $smof_data['team_twitter']; ?>" class="twitter-link"></a>
                                        <?php } ?>
                                        <?php if (!(empty($smof_data['team_forrst']))){ ?>
                                        <a href="<?php echo $smof_data['team_forrst']; ?>" class="forrst-link"></a>
                                        <?php } ?>
                                        <?php if (!(empty($smof_data['team_dribbble']))){ ?>
                                        <a href="<?php echo $smof_data['team_dribbble']; ?>" class="dribbble-link"></a>
                                        <?php } ?>
                                      ...
                                      <?php if ($smof_data['join_us_switch2'] ) { ?>
                                      <div class="join fadeitin">
                                        <div class="join-cont">
                                          <div class="join-title"><?php echo $smof_data['join_us_title2']; ?></div>
                                          <div class="join-text">
                                              <?php echo $smof_data['join_us_text2']; ?>
                                          </div>
                                          <div class="join-button">
                                            <a href="<?php echo $smof_data['join_us_but2']; ?>" class="team-button"><?php echo $smof_data['join_us_but_text2']; ?></a>
                                          </div>
                                          <div class="call-clearfix"></div>
                                        </div>
                                        <div class="call-clearfix"></div>
        ...
        case 'twitters': ?>
              <!--         Twitter Section           -->
              <?php
              if ((isset($smof_data['twitter_bg'] )) && ($smof_data['twitter_bg']!=="") ) {
                      $twitter_bg = $smof_data['twitter_bg'];
                  }else{
                      $twitter_bg = "";
                  }
                  if ((isset($smof_data['twitter_color'] )) && ($smof_data['twitter_color']!=="") ) {
                      $twitter_color = $smof_data['twitter_color'];
                  }else{
              ...
              <section id="twitter" class="bg-twitter" style="background:url(<?php echo $twitter_bg ;?>) <?php echo $twitter_color ;?>;overflow:auto;">
                  <div class="section-one section-twitter">
                      ...
                      <div id="ftwitter" user-id="<?php echo $smof_data['twitter_id']; ?>">
                      </div>
                  </div>
        ...
        break;
         case 'contact': ?>
              <!--         Google Map Section         -->
              <?php if (!empty($smof_data['map_link'])) { ?>
              <section id="map" class="bg-map">
                  <iframe style="width:100%;height:100%;" src="<?php echo $smof_data['map_link']; ?>&amp;output=embed"></iframe>
             ...
             <!--      Contact Us Section         -->
              <div id="contact" class="container bg-two"><div id="href_contact"></div> 
                  <div class="section-two">
                    <div class="service-title fadeitin"><img src="<?php echo get_template_directory_uri(); ?>/img/map.png" alt="" class="service-img"><?php echo $smof_data['contact_title']; ?></div>
                      <div class="data-content-about">
                          <?php echo $smof_data['contact_headline']; ?>
                      </div>
                       <div class="data-content-about">
                          <span class="contact-label1">Address: <span class="blue-text"><?php echo $smof_data['contact_location']; ?></span></span>
                          <span class="contact-label2">Email: <span class="blue-text"><?php echo $smof_data['contact_info_email']; ?></span></span>
                          <span class="contact-label2">Phone: <span class="blue-text"><?php echo $smof_data['contact_phone']; ?></span></span>
                     ...
                     <div class="message" style="display:none"><div id="contact_alert" class="call-to-action clearfix"></div></div>
                      ...
                      <div class="call-clearfix"></div>
                      <p class="submit-text"><span class="submit-message"><?php echo $smof_data['contact_note']; ?><span class="blue-text">* </span></span><input type="submit" value="<?php _e('Send Message', 'flatbox'); ?>" id="submit-but" class="submit"/></p> 
