...
$meta_boxes[] = array(
	'id' => 'm_tagline',
	'title' => __( 'Tagline', 'flatbox' ),
	'pages' => array( 'staff-members' ),
	'fields' => array(
		array(
			'name' => __( 'Tagline', 'flatbox' ),
			'id'   => 'member_tagline',
			'type' => 'text',
			'size' => 40,
		),
...
$meta_boxes[] = array(
	...
	'fields' => array(
		...
		array(
			'name' => __( 'Google plus Profile', 'flatbox' ),
			'id'   => 'social_link_newgoogleplus',
			'type' => 'text',
			'size' => 40,
		),
	)
