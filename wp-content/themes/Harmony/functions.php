...
?>
	<style>
		#main-header { background-image: url(<?php echo esc_attr( et_get_option( 'harmony_header_bg_image', $template_directory .  '/images/bg.jpg' ) ); ?>); }
		#songs { background-image: url(<?php echo esc_attr( et_get_option( 'harmony_songs_bg_image', $template_directory .  '/images/bg.jpg' ) ); ?>); }
		#media-gallery { background-image: url(<?php echo esc_attr( et_get_option( 'harmony_media_bg_image', $template_directory .  '/images/bg.jpg' ) ); ?>); }
	</style>
<?php 
}
