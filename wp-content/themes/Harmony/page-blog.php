		...
		<div id="content-area" class="clearfix<?php if ( $fullwidth ) echo ' fullwidth'; ?>">
			...
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<div id="et_pt_blog" class="responsive">
					...
					?>
					<?php $blog_page_query = new WP_Query( "posts_per_page=$et_ptemplate_blog_perpage&paged=" . $et_paged . $cat_query ); ?>
					<?php if ( $blog_page_query->have_posts() ) : while ( $blog_page_query->have_posts() ) : $blog_page_query->the_post(); ?>
