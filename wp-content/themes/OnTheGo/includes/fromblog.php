	...
	<div id="from-blog" class="clearfix">
		...
		<div class="entries">
			...
			<div id="recent-tabbed" class="tabcontent">
				<?php query_posts("showposts=".get_option('onthego_fromblog_recent')."&cat=".get_catid(get_option('onthego_blog_cat')));
			...
			<div id="random-tabbed" class="tabcontent">
				<?php query_posts("showposts=".get_option('onthego_fromblog_random')."&ignore_sticky_posts=1&orderby=rand&cat=".get_catid(get_option('onthego_blog_cat')));
				if (have_posts()) : while (have_posts()) : the_post(); ?>
					<?php get_template_part('includes/fromblog_post'); ?>
				<?php endwhile; endif; wp_reset_query(); ?>
			</div> <!-- end recent-tabbed -->
