...
if ( ! function_exists( 'et_setup_theme' ) ){
	function et_setup_theme(){
		...
		load_theme_textdomain('OnTheGo',get_template_directory().'/lang');

		require_once(TEMPLATEPATH . '/epanel/options_onthego.php');

		require_once(TEMPLATEPATH . '/epanel/core_functions.php'); 

		require_once(TEMPLATEPATH . '/epanel/post_thumbnails_onthego.php');
