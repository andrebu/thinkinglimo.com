...
function custom_colors_css(){
	...
	<style type="text/css">
		...
		ul#top-menu li a { color: #<?php echo(get_option($shortname.'_color_pagelink')); ?>; }
		ul#top-menu > li.current_page_item > a, ul#top-menu > li:hover > a, ul#top-menu > li.current-cat > a { color: #<?php echo(get_option($shortname.'_color_pagelink_active')); ?>; }
		...
		#footer-widgets .widget h4 { color:#<?php echo(get_option($shortname.'_footer_headings')); ?> }
		#footer-widgets .widget-content, #footer-widgets a { color:#<?php echo(get_option($shortname.'_color_footerlinks')); ?> }
	</style>
