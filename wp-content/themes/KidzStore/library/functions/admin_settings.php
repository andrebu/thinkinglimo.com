...
<?php 
	...
	if ( $_REQUEST['saved'] ) echo '<div id="message" class="updated fade"><p><strong>'.$themename.' '.__('settings saved!').'&nbsp; <a href="'.$bloghomeurl.'">'.__('Check out your blog').' &rarr;</a></strong></p></div>';
    if ( $_REQUEST['reset'] ) echo '<div id="message" class="updated fade"><p><strong>'.$themename.' '.__(' settings reset!').'&nbsp; <a href="'.$bloghomeurl.'">'.__('Check out your blog').' &rarr;</a></strong></p></div>'; 
