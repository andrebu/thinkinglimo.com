...
<form id="shopingcartfrm" name="shopingcartfrm">
  ...
  <div class="addtocart"> <a href="javascript:void(0);" onclick="setAttributeVal();" > <img src="<?php echo get_option('siteurl');?>/wp-content/themes/<?php echo get_option('template');?>/images/i-btn-buynow.png" alt=""  /></a> </div>
</form>
<?php }?>
