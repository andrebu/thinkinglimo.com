...
<div id="wrapperinner">
	<div id="mainheading">
		<div id="heading">
			<h2><?php _e(AFFILIATE_LOGIN_BREADCUM); ?></h2>
             <div class="breadcrumb clearfix"><?php if ( get_option( 'ptthemes_breadcrumbs' )) { yoast_breadcrumb('',' &raquo; '.AFFILIATE_LOGIN_BREADCUM); } ?></div>
		</div>
	</div>
</div>

<div class="wrapper" >
  <?php /*?><div class="clearfix container_border">
    <h1 class="head">
...
?>
        <div class="fr"><p><span class="forgot_password"><?php _e(NEW_USER_REGISTRATION_TEXT);?><a href="<?php echo get_option( 'siteurl' ).'/?page=affiliate&type=reg';?>"><?php _e(NEW_USER_REGISTRATION_LINK);?></a></span></p></div>
