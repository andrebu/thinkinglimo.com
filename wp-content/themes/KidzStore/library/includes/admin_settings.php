...
if($_POST)
{
	...
	if($cartinfo)
	{
		foreach($cartinfo as $cartinfoObj)
		{
			...
			$bill_phone = 	$option_value['bill_phone'];
			...
			$is_on_ssl_login = 	$option_value['is_on_ssl_login'];			
		}
	}
...
>
	  ...
	  <tr><td colspan="2"><h2><?php _e('Stock Settings'); ?></h2></td></tr>
       ...
       <tr>
        <td><?php _e('Enable SSL - https while checkout'); ?></td>
       ...
       <tr>
        <td><?php _e('Enable SSL - https while Login'); ?></td>
        <td><select name="is_on_ssl_login">
            <option value="1" <?php if($is_on_ssl_login==1){?> selected="selected"<?php }?>>Yes</option>
            <option value="0" <?php if($is_on_ssl_login=='0'){?> selected="selected"<?php }?>>No</option>
          </select>        </td>
      </tr>
      <tr>
     ...
     <?php /*?> <tr>
      ...
      <tr>
       ...
       <tr>
        ...
        &nbsp;&nbsp;<input type="checkbox" name="bill_zip" value="1" <?php if($bill_zip){?> checked="checked"<?php }?> /> Postal Code       
          &nbsp;&nbsp;<input type="checkbox" name="bill_phone" value="1" <?php if($bill_phone){?> checked="checked"<?php }?> /> Phone   </td>
      </tr>
      <tr>
