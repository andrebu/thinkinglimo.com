...
?>
<h3 class="clearfix"><span class="fl"> <?php _e(CHANGE_PASSWORD_TEXT); ?> </span>    <span class="fr"><a href="<?php echo get_option('siteurl'); ?>/?page=login&amp;action=logout" > <?php _e(LOGOUT_TEXT);?></a></span> </h3>
...
<div class="myorders ">
     <div class="myorders_col myorders_col_2 fl">
        ...
        <label>
        <?php _e(NEW_PASSWORD_TEXT); ?> <span class="indicates">*</span></label> 
        ...
        <input type="submit" name="Update2" value="<?php _e(UPDATE_BUTTON_TEXT) ?>" class="highlight_input_btn fl" onclick="return chk_form_pw();" />
    </div>
</div>
</form>
...
<h3><?php _e(PERSONAL_INFO_TEXT);?>  
  <?php
  if($login_redirect_link)
  {
  ?>
  <input type="button" name="<?php _e('Checkout');?>" value="<?php _e(CHECKOUT_TEXT);?>" onclick="window.location.href='<?php echo $login_redirect_link;?>'"  class="highlight_input_btn fr" />
  <?php }?>
  ...
  <div class="myorders sepretor ">
    <div class="myorders_col fl">
      ...
      <div class="myorder_form_row ">
       ...
       <div class="myorder_form_row ">
        <label>
        <?php _e('Phone');?> <?php echo $bill_phone;?>
        </label>
...
function chk_form_profile()
{
	...
	{
		alert("<?php _e('Please enter');?> <?php _e(FIRST_NAME_TEXT) ?>");
	...
	?>
		...
		{
			alert('<?php _e('Please enter ');?> <?php _e(ADDRESS1_TEXT) ?>');
	...
	?>
		...
		{
			alert('<?php _e('Please enter ');?> <?php _e(ADDRESS2_TEXT) ?>');
	...
	?>
		...
		{
			alert('<?php _e('Please enter ');?> <?php _e(CITY_TEXT) ?>');
	...
	?>
		...
		{
			alert('<?php _e('Please enter ');?> <?php _e(STATE_TEXT) ?>');
	...
	?>
		...
		{
			alert('<?php _e('Please enter ');?> <?php _e(COUNTRY_TEXT) ?>');
	...
	?>
		...
		{
			alert('<?php _e('Please enter ');?> <?php _e(POSTAL_CODE_TEXT) ?>');
