...
<form id="shopingcartfrm" name="shopingcartfrm">
  ...
  <div class="row_spacer clearfix">
   <span class="field_text"><?php _e('Qty:');?></span> <input name="product_qty" id="product_qty" type="text" onKeyPress="return numberonly(event)" value="1" class="textfield" />
  </div>
...
{
?>
  <div class="row_spacer"  id="shoppingcart_button_1"><a href="javascript:void(0);" onclick="setAttributeVal();"><img src="<?php echo get_option('siteurl');?>/wp-content/themes/<?php echo get_option('template');?>/images/i-btn-addtocart.png" alt="" /></a></div>
