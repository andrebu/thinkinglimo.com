...
$shipping_amt = $General->get_shipping_amt($_REQUEST['paymentmethod'],$cart_amount);
$shipping_method = $General->get_shipping_method($_REQUEST['shippingmethod']);
