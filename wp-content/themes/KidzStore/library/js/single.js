...
if ($('.' + $(this).attr("title")).length > 0) {
	...
	$('#infoHolder').html('<div id="info">' + $('.' + source).html() + '<p class="clear"><span class="close"  onclick="document.getElementById(infoHolder).style.display=none">Close X</span></p></div>');
