...
DD_belatedPNG.fix('.button a');
DD_belatedPNG.fix( '.button a:hover' );
DD_belatedPNG.fix('.button');
DD_belatedPNG.fix( '.button:hover' );
DD_belatedPNG.fix( '#content p.info' );
DD_belatedPNG.fix( '#content p.note' );
DD_belatedPNG.fix( '#content p.alert' );
DD_belatedPNG.fix( '#content p.download' );
DD_belatedPNG.fix( '#sidebar_r h3.tag_cloud, #sidebar_l h3.tag_cloud' );
DD_belatedPNG.fix( '.popup img' );
DD_belatedPNG.fix( '.b_buynow span' );
DD_belatedPNG.fix( '#sidebar_r h3' );
DD_belatedPNG.fix( '#header-in img' );
DD_belatedPNG.fix( '#theme_details_sidebar .theme_info li' );
DD_belatedPNG.fix( '.commentcount ' );
DD_belatedPNG.fix( '.themes_gallery .caption' );
DD_belatedPNG.fix( '.themes_gallery .caption' );
DD_belatedPNG.fix( '.b_viewallourthemes span' );
DD_belatedPNG.fix( '.product_image img' );
